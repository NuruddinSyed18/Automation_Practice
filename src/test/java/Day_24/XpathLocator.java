...
public class XpathLocator {
	...
	public static void main(String[] args) {
		...
		/*
		 * boolean
		 * displaystatus=driver.findElement(By.xpath("//h3[text()='Featured']")).
		 * isDisplayed(); System.out.println(displaystatus);
		 * 
		 * String
		 * value=driver.findElement(By.xpath("//h3[text()='Featured']")).getText();
